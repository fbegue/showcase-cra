...
export const PIEDATA = makeVar([]);
export const PIEDATADRILLDOWN = makeVar({series: []});
export const PIEDATAGUEST = makeVar([]);
export const PIEDATADRILLDOWNGUEST = makeVar({series: []});
export const BARDATA = makeVar([]);
export const BARDRILLDOWNMAP = makeVar({});
export const CHIPGENRESRANKED = makeVar([]);
export const CHIPFAMILIESRANKED = makeVar([]);
export const CHIPGENRESRANKEDMAP = makeVar({});
export const CHIPFAMILIESRANKEDMAP = makeVar({});
export const CHIPGENRESCOLORMAP = makeVar({});
export const CHIPGENRESCOMBINEDMAP = makeVar({});
